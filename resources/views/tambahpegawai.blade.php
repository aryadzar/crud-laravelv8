...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <form action="/insertdata" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" name="no_telpon" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>
                    <div class="mb-3">
